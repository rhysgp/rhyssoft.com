      ...
      <div style="margin-bottom: 75px">
        <a class="linkedin" href="https://www.linkedin.com/in/rhys-parsons-7441822?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BnhAeM%2FxXSeuFB6bqPhGOuA%3D%3D" target="_blank">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" class="mercado-match" width="24" height="24" focusable="false">
            ...
            <title>View my profile on LinkedIn...</title>
          </svg>
        </a>
        <a rel="me" href="https://mastodonapp.uk/@pyrrho" target="_blank">
          <svg width="24" height="24" viewBox="0 0 75 79" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <title>View my profile on Mastodon...</title>
          </svg>
        </a>
      </div>
      <hr>
      <p>
        <a href="https://en.wikipedia.org/wiki/File:Eye_of_Horus_bw.svg">The Eye of Horus</a>
        image is by Jeff Dahl and is available under the Creative Commons licence.
      </p>
    </div>
  </Content>
</template>
